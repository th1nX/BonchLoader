...
def main():
    ...
    class App(customtkinter.CTk):
        def __init__(self):
            ...
            self.button_frame.grid(row=1, column=0, padx=10, pady=10, sticky="nw")
            ...
            self.button_2.grid(row=2, column=0, padx=10, pady=10, sticky="w")

            self.button_frame2 = customtkinter.CTkFrame(self)
            self.button_frame2.grid(row=1, column=0, padx=(180, 0), pady=10, sticky="nw")
            ...
            self.combobox.grid(row=2, column=0, padx=10, pady=10, sticky="w")

            self.textbox = customtkinter.CTkTextbox(self)
            self.textbox.grid(row=0, column=0, sticky="we", padx=10, pady=(10, 0))

            self.button = customtkinter.CTkButton(self, text="Start update", command=self.start_update)
            self.button.grid(row=2, column=0, padx=20, pady=(0, 10), sticky="sew", columnspan=1)

            self.textbox.insert(0.0, f"\nBONCH - Best minecraft modpack updater\n")
